...
function multiply(thistxt) {
    ...
    // ============================================================
    // var paraData = $('#possibility_' + splited_data[1]).html();
    // console.log('paradata : ',paraData);
    // var data = paraData.split(':');
    // if (questionData > parseInt(data[1])){
    //     Swal.fire('<small>Assigned question qunatity is more than max. limit.</small>');
    //     var questionData = $('#noOfQuestion_' + splited_data[1]).val('');
    //     var marksPerQuestData = $('#marksPerQues_' + splited_data[1]).val('');
    // }
    // ============================================================
