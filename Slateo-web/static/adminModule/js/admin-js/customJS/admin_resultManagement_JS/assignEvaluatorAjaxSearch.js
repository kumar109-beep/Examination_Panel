...
// =======================================================================================================================================
//                                                  Search For ASSIGN EVALUATORS 
// =======================================================================================================================================
function resourceAjaxSearch() {

}
// =======================================================================================================================================
//                                                  Paginator For ASSIGN EVALUATORS 
// =======================================================================================================================================
// --------------------------------------------------------    Next Button   -------------------------------------------------------------
function studentpaginatorNextButton() {
    ...
    console.log('courseID:',courseID.length,'\n','SubjectID:',SubjectID.length,'\n','year:',year.length);
    // ---------------------------  next [search + pagination]   ---------------------------------------------------------
    if (courseID.trim().length != 0 && SubjectID.trim().length != 0 && year.trim().length != 0) {
        // ----------------   AJax Call   --------------------
        $.ajax({
            type: 'GET',
            url: "completedPapersSearch",
            data: {'courseID':courseID,'SubjectID':SubjectID,'year':year, 'page': next},
...
function studentpaginatorPreviousButton() {
    ...
    if (courseID.trim().length != 0 && SubjectID.trim().length != 0 && year.trim().length != 0) {
        ...
        $.ajax({
            type: 'GET',
            url: "completedPapersSearch",
            data: {'courseID':courseID,'SubjectID':SubjectID,'year':year,'page': newPrev},
            success: function (response) {
                console.log(response['searchResultList']);
                Swal.close()
                // -------------------------------------------------------------------------------------------------
...
// =======================================================================================================================================
// =======================================================================================================================================
//                                                     searchCompletedPapers
// =======================================================================================================================================
function searchCompletedPapers(){
    var courseID = $('#coursenameId').val();
    var SubjectID = $('#subjectnameId').val();
    var year = $('#year').val();
    if (courseID.trim().length != 0 && SubjectID.trim().length != 0 && year.trim().length != 0) {
        ...
        if (courseID.trim().length == 0) {
            Swal.fire({
                    icon: 'info',
                    title: '<small>select course</small>',
                })
            return false;
        }else if (SubjectID.trim().length == 0) {
            Swal.fire({
                    icon: 'info',
