      ...
      var myHeaders = new Headers();
        ...
        fetch("http://13.233.247.133/api/role_detail/" + id + "/",requestOptions)
            ...
            .then(result => {
                ...
                var assign = eval(data['data']['assign_authority']);
...
function submitAuthority() {
    ...
    if (dataText == '') {
        ...
        Swal.fire({
            icon: 'info',
            title: '<small>Select AtLeast One Authority</small>',
        ...
        Swal.fire({
            position: 'center',
            title: "<b style='font-size:20px;font-weight:500;color:#1eb6e9;'>Updating Authorities</b>",
            showConfirmButton: false,
            onOpen: () => {
                Swal.showLoading();
            }
        ...
        myHeaders.append("Authorization", "Token " + tokenKey + "");
        myHeaders.append("Content-Type", "application/json");
        var raw = JSON.stringify({"roleID": $('#roleID').text().trim(),"roleName": $('#roleName').text().trim(),"assign_authority": JSON.stringify(authDataList)});
        console.log(raw);
        var requestOptions = {
            method: 'PUT',
            headers: myHeaders,
        ...
        fetch("http://13.233.247.133/api/role_detail/" + id + "/", requestOptions)
            ...
            .then(result => {
                ...
                Swal.fire({
                    icon: 'success',
                    title: '<small>Authorities Updated Successfully.</small>',
                    showConfirmButton: false,
                    timer: 1500
                }).then(function(){
                    window.location.reload();
