    ...
    $('#upload_csv_file').bind('click', function () {
        ...
        if (regex.test($('#browse_csv_file').val().toLowerCase())) {
            if (typeof FileReader != 'undefined') {
                ...
                // var store_header = '';
                // var store_menu = '';
                // var header_list = ['EmployeeCode', 'ResourceName', 'Department', 'SubjectSpecialist', 'Contact', 'Email', 'DateOfBirth', 'Gender', 'Education', 'Experience','Address','Country','District','State','Pincode'];
            ...
            Swal.fire('<small>Please select a valid .csv/.xls file.</small>');
...
//         // ========================================================
//         var arr_employeeCode = [];
//         var arr_resourceName = [];
//         var arr_department = [];
//         var arr_subjectSpeciality = [];
//         var arr_contact = [];
//         var arr_email = [];
//         var arr_dob = [];
//         var arr_gender = [];
...
//             if ($(this).val().trim() != '') {
//                 arr_employeeCode.push($(this).val().trim())
//             }
//         });
...
//             if ($(this).val().trim() != '') {
//                 arr_resourceName.push($(this).val().trim())
//             }
...
//             if ($(this).val().trim() != '') {
//                 arr_department.push($(this).val().trim())
//             }
//         });
...
//             if ($(this).val().trim() != '') {
//                 arr_subjectSpeciality.push($(this).val().trim())
//             }
//         });
...
//             if ($(this).val().trim() != '') {
//                 arr_contact.push($(this).val().trim())
//             }
//         });
...
//             if ($(this).val().trim() != '') {
//                 arr_education.push($(this).val().trim())
//             }
//         });
...
//             if ($(this).val().trim() != '') {
//                 arr_experience.push($(this).val().trim())
//             }
...
//             if ($(this).val().trim() != '') {
//                 arr_address.push($(this).val().trim())
//             }
...
//             if ($(this).val().trim() != '') {
//                 arr_country.push($(this).val().trim())
//             }
...
//             if ($(this).val().trim() != '') {
//                 arr_district.push($(this).val().trim())
//             }
...
//             if ($(this).val().trim() != '') {
//                 arr_pincode.push($(this).val().trim())
//             }
...
//         if (arr_employeeCode.length <= 0) {
//             Swal.fire("Employee Code is a madatory field.");
//             return false;
//         }
//         else if (arr_contact.length <= 0) {
//             Swal.fire("Employee Contact is a madatory field.");
//             return false;
//         }
//         else if (arr_email.length <= 0) {
//             Swal.fire("Employee Email is a madatory field.");
//             return false;
//         }
...
//         $.ajax({
//             type: 'POST',
//             url: "upload_excel_resource_data",
//             headers: { 'X-CSRFToken': csrftoken },
//             data: {'employeeCode': arr_employeeCode, 'resourceName': arr_resourceName, "resourceDepartment": arr_department, "subjectSpeciality": arr_subjectSpeciality, "contact": arr_contact, "email": arr_email, "dob": arr_dob, "gender": arr_gender, "education": arr_education, "experience": arr_experience,'address':arr_address,'country':arr_country,'district':arr_district,'state':arr_state,'pincode':arr_pincode },
...
// // ---===============----
// function validateEmployeeCode(inputtxt) {
//     const re = /^[a-zA-Z0-9]+$/;
...
//     if (realHeader === 'EmployeeCode') {
//         for (var i = 0; i < data_list.length; i++) {
//             var column = data_list[i].trim().length != 0 ? data_list[i] : "NA";
//             var isName = validateEmployeeCode(data_list[i]);
...
//         }
//     }
//     else if (realHeader === 'ResourceName') {
...
//         }
//     }
//     else if (realHeader === 'DateOfBirth') {
//         for (var i = 0; i < data_list.length; i++) {
//             var column = data_list[i].trim().length != 0 ? data_list[i] : "NA";
...
//         }
//     }
//     else if (realHeader === 'SubjectSpecialist') {
...
//     if (realHeader.trim() === 'Department') {
//         var isName = validation_Name(data);
//         isName === true ? $(pointer).css({ 'color': 'black' }) : $(pointer).css({ 'color': 'red' });
//     }
//     else if (realHeader.trim() === 'Subject Specialist') {
//         var isName = validation_Name(data);
//         isName === true ? $(pointer).css({ 'color': 'black' }) : $(pointer).css({ 'color': 'red' });
//     }
//     else if (realHeader.trim() === 'Education') {
//         var isName = validation_Name(data);
//         isName === true ? $(pointer).css({ 'color': 'black' }) : $(pointer).css({ 'color': 'red' });
//     }
//     else if (realHeader.trim() === 'Experience') {
//         var isName = validation_Name(data);
//         isName === true ? $(pointer).css({ 'color': 'black' }) : $(pointer).css({ 'color': 'red' });
//     }
//     else if (realHeader.trim() === 'Employee Code') {
//         var isNumber = validateRegistrationNumber(data);
//         isNumber === true ? $(pointer).css({ 'color': 'black' }) : $(pointer).css({ 'color': 'red' });
//     }
//     else if (realHeader.trim() === 'Contact') {
//         var isNumber = phonenumber(data);
//         isNumber === true ? $(pointer).css({ 'color': 'black' }) : $(pointer).css({ 'color': 'red' });
//     }
//     else if (realHeader.trim() === 'Date Of Birth') {
...
//     }
//     else if (realHeader.trim() === 'Email') {
//         var isEmail = validateEmail(data);
//         isEmail === true ? $(pointer).css({ 'color': 'black' }) : $(pointer).css({ 'color': 'red' });
//     }
//     else if (realHeader.trim() === 'Address') {
//         var isEmail = validation_Name(data);
//         isEmail === true ? $(pointer).css({ 'color': 'black' }) : $(pointer).css({ 'color': 'red' });
//     }
//     else if (realHeader.trim() === 'Country') {
//         var isEmail = validation_Name(data);
//         isEmail === true ? $(pointer).css({ 'color': 'black' }) : $(pointer).css({ 'color': 'red' });
//     }
//     else if (realHeader.trim() === 'District') {
//         var isEmail = validation_Name(data);
//         isEmail === true ? $(pointer).css({ 'color': 'black' }) : $(pointer).css({ 'color': 'red' });
//     }
//     else if (realHeader.trim() === 'State') {
//         var isEmail = validation_Name(data);
//         isEmail === true ? $(pointer).css({ 'color': 'black' }) : $(pointer).css({ 'color': 'red' });
//     }
//     else if (realHeader.trim() === 'Pincode') {
//         var isEmail = validation_Name(data);
//         isEmail === true ? $(pointer).css({ 'color': 'black' }) : $(pointer).css({ 'color': 'red' });
//     }
// }
